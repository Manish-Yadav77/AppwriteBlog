...
[https://appwriteblogs.netlify.app/)
...
<p>4. install Appwrite</p>

```
npm i Appwrite
```

<p>5. Install some more features like router redux etx..</p>

```
read readdme file clearly
```

<p>6. now run the program</p>
